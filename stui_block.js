...
var stui = {
	...
	'common': {//公共基础
		...
		'share': function(){
			if(baidushare!=0){
				$(".share").html('<span class="bds_shere"></span><a class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a class="bds_weixin" data-cmd="weixin" title="分享到微信"></a><a class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a class="bds_bdhome" data-cmd="bdhome" title="分享到百度新首页"></a><a class="bds_more" data-cmd="more" title="更多"></a>');
